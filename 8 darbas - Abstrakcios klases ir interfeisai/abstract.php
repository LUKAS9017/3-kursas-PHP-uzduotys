<?php
abstract class abstraktas {
    abstract function __destruct();
}

class PrimeNumbers extends abstraktas { //pirminiu skaiciu gavimo klase
    private $limit;
...
class pavadinimas extends abstraktas {
    private $name;
...
class Fibonacci extends abstraktas {
    private $pirmas;
    private $antras;
    private $suma;
    private $f;
...
class formule extends abstraktas {
    private $x;
    private $i;
