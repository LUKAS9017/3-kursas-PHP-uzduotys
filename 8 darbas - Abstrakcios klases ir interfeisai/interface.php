<?php
interface face { //pridejau interface
    function __destruct();
}

class PrimeNumbers implements face { //pirminiu skaiciu gavimo klase
    private $limit;

    function __construct($limit) { //pirminiam skaiciui apskaiciuoti
        $this->limit = $limit;
    }
...
class pavadinimas implements face {
    private $name;
...
class Fibonacci implements face {
    private $pirmas;
    private $antras;
    private $suma;
    private $f;
